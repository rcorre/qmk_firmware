...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,             KC_B,             KC_N,          KC_M,            KC_COMM,       KC_DOT,       KC_SLSH,         KC_RSFT,
                                             KC_SPC,       LGUI_T(KC_TAB),   KC_LGUI,          LT(1, KC_ENT), LT(2, KC_BSPC),  KC_ESC
    ),
    ...
    [2] = LAYOUT_split_3x6_3(
         _______, KC_WH_U, KC_MS_U, KC_WH_D,    _______,    _______,                           _______, _______, _______, _______, _______, QK_BOOT,
         _______, KC_MS_L, KC_MS_D, KC_MS_R,    _______,    _______,                           _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, _______,
